...
export default [
  ...
  {
    title:
      '[Presenter] M-Flash: Fast Billion-scale Graph Computation Using a Bimodal Block Processing Model',
    authors: [
      'Hugo Gualdron',
      'Robson Cordeiro',
      'Jose Rodrigues-Jr',
  ...
  },
  {
    ...
    authors: ['Minsuk Kahng', 'Dezhi Fang', 'Duen Horng (Polo) Chau'],
    venue:
  ...
  },
  {
    ...
    authors: ['Dezhi Fang', 'Duen Horng (Polo) Chau'],
    venue:
